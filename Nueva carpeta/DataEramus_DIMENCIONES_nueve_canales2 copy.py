...
for i in range(1, 775):  # desde EGD-0001 a EGD-0774
    ...
    slices_path = os.path.join(folder_path, "T1_axial_slices.nii.gz")  # Path del archivo de cortes axiales
    
    if os.path.exists(slices_path):
        # Eliminar el archivo de cortes axiales si existe
        os.remove(slices_path)
        print(f"Eliminado {slices_path}")
